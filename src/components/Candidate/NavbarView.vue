<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="div1">
    <a id="navbar-brand" href="#">A<span>-</span>M<span>-</span>N<span>-</span>H</a>
    <p id="navbar-brand2" href="#"><span id="letter">A</span>spire<span id="letter">M</span>atch <span id="letter">N</span>etwork <span id="letter">H</span>ub</p>
