      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="text-center card-box">
            <!-- Additional content for card-box if needed -->
            <img style="padding-top: 20px;" src="../../assets/applications.png" height="200" width="200" />
        ...
        <div class="col-md-8 col-lg-9">
          <div>
            <ul class="nav nav-tabs navtab-custom">
              ...
              <li class="nav-item">
                <RouterLink class="nav-link" to="/employer/approvedApplications" style="color: rgb(0, 119, 255) !important;font-weight: 700;">Approved</RouterLink>
              </li>
              <li class="nav-item">
